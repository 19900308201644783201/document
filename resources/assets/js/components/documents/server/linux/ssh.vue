  ...
  <div class="col-md-10 col-md-offset-2 main">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h1 class="text-center">Initial Server Setup with Ubuntu 16.04</h1>
      </div>
    ...
    <div name="step-one-—-root-login" data-unique="step-one-—-root-login"></div>
    <h2 id="step-one-—-root-login">Step One — Root Login</h2>

    <p>To log into your server, you will need to know your server's public IP address. You will also need the password or, if you installed an SSH key for authentication, the private key for the "root" user's account. If you have not already logged into your server, you may want to follow the first tutorial in this series, <a href="https://www.digitalocean.com/community/tutorials/how-to-connect-to-your-droplet-with-ssh">How to Connect to Your Droplet with SSH</a>, which covers this process in detail.</p>
    ...
    <div name="step-two-—-create-a-new-user" data-unique="step-two-—-create-a-new-user"></div>
    ...
    <div name="step-three-—-root-privileges" data-unique="step-three-—-root-privileges"></div>
    ...
    <div name="step-four-—-add-public-key-authentication-(recommended)" data-unique="step-four-—-add-public-key-authentication-(recommended)"></div>
    ...
    <pre class="code-pre  local-environment"><code langs=""><div class="secondary-code-label " title="ssh-keygen output">ssh-keygen output</div>Generating public/private rsa key pair.
Enter file in which to save the key (/Users/<span class="highlight">localuser</span>/.ssh/id_rsa):
    ...
    <span class="note"><p>
<strong>Note</strong>: The <code>ssh-copy-id</code> method will not work on DigitalOcean if an SSH key was selected during Droplet creation.  This is because DigitalOcean disables password authentication if an SSH key is present, and the <code>ssh-copy-id</code> relies on password authentication to copy the key.</p>

<p>If you are using DigitalOcean and selected an SSH key during Droplet creation, use <a href="#option-2-manually-install-the-key">option 2</a> instead.<br></p></span>
    ...
    <pre class="code-pre command local-environment"><code langs=""><ul class="prefixed"><li class="line" prefix="$">ssh-copy-id <span class="highlight">sammy</span>@<span class="highlight">your_server_ip</span>
</li></ul></code></pre>
    ...
    <pre class="code-pre  local-environment"><code langs=""><div class="secondary-code-label " title="id_rsa.pub contents">id_rsa.pub contents</div>ssh-rsa  localuser@machine.local
</code></pre>
    ...
    <p>To read more about how key authentication works, read this tutorial: <a href="https://www.digitalocean.com/community/tutorials/how-to-configure-ssh-key-based-authentication-on-a-linux-server">How To Configure SSH Key-Based Authentication on a Linux Server</a>.</p>

    <p>Next, we'll show you how to increase your server's security by disabling password authentication.</p>

    <div name="step-five-—-disable-password-authentication-(recommended)" data-unique="step-five-—-disable-password-authentication-(recommended)"></div>
...
ChallengeResponseAuthentication no
    ...
    <div name="step-six-—-test-log-in" data-unique="step-six-—-test-log-in"></div>
    ...
    <div name="step-seven-—-set-up-a-basic-firewall" data-unique="step-seven-—-set-up-a-basic-firewall"></div>
...
OpenSSH (v6)               ALLOW       Anywhere (v6)
    ...
    <div name="where-to-go-from-here" data-unique="where-to-go-from-here"></div>
