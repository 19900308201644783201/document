  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="text-center">How To Install Linux, Nginx, MySQL, PHP (LEMP stack) in Ubuntu 16.04</h3>
      </div>
      <div class="panel-body">
        ...
        <div name="step-1-install-the-nginx-web-server" data-unique="step-1-install-the-nginx-web-server"></div>
        <h2>Step 1: Install the Nginx Web Server</h2>
        ...
        <p>If you have the <code>ufw</code> firewall running, as outlined in our initial setup guide, you will need to allow connections to Nginx. Nginx registers itself with <code>ufw</code> upon installation, so the procedure is rather straight forward.</p>
...
Nginx HTTP (v6)            ALLOW       Anywhere (v6)
    ...
    <pre class="code-pre "><code langs="">http://<span class="highlight">server_domain_or_IP</span>
        ...
        <div name="step-2-install-mysql-to-manage-site-data" data-unique="step-2-install-mysql-to-manage-site-data"></div>
        <h2>Step 2: Install MySQL to Manage Site Data</h2>
...
Change the password for root ? ((Press y|Y for Yes, any other key for No) : <span class="highlight">n</span>
        ...
        <div name="step-3-install-php-for-processing" data-unique="step-3-install-php-for-processing"></div>
        <h2>Step 3: Install PHP for Processing</h2>
    ...
    <div name="step-4-configure-nginx-to-use-the-php-processor" data-unique="step-4-configure-nginx-to-use-the-php-processor"></div>
    ...
    <ul>
        ...
        <li>For the actual PHP processing, we just need to uncomment a segment of the file that handles PHP requests by removing the pound symbols (#) from in front of each line. This will be the <code>location ~\.php$</code> location block, the included <code>fastcgi-php.conf</code> snippet, and the socket associated with <code>php-fpm</code>.</li>
        <li>We will also uncomment the location block dealing with <code>.htaccess</code> files using the same method. Nginx doesn't process these files. If any of these files happen to find their way into the document root, they should not be served to visitors.</li>
    </ul>
    ...
    <div name="step-5-create-a-php-file-to-test-configuration" data-unique="step-5-create-a-php-file-to-test-configuration"></div>
    <h2>Step 5: Create a PHP File to Test Configuration</h2>
...
phpinfo();
    ...
    <p class="growable"><img src="https://assets.digitalocean.com/articles/lemp_ubuntu_1604/php_info.png" alt="PHP page info"></p>
    ...
    <div name="conclusion" data-unique="conclusion"></div>
    <h2>Conclusion</h2>
